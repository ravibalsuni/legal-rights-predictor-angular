...
import { ACCUSED_PREDICT_MARATHI_ENDPOINT, ACCUSED_TRANSLATE_MARATHI_ENDPOINT, API_URL, PREDICT_MARATHI_ENDPOINT, TRANSLATE_MARATHI_ENDPOINT } from 'src/app/constants';
