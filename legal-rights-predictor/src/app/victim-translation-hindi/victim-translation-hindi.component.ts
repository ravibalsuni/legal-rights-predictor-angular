...
import { API_URL, PREDICT_HINDI_ENDPOINT, PREDICT_MARATHI_ENDPOINT, SAVE_CHAT_ENDPOINT, TRANSLATE_HINDI_ENDPOINT, TRANSLATE_MARATHI_ENDPOINT } from 'src/app/constants';


@Component({
  selector: 'app-victim-translation-hindi',
  templateUrl: './victim-translation-hindi.component.html',
  styleUrls: ['./victim-translation-hindi.component.css']
})
export class VictimTranslationHindiComponent implements OnInit {
  ...
  @ViewChild('messageContainer') messageContainer?: ElementRef;
    ...
    sendMessage() {
        ...
        this.http.post(`${API_URL}${PREDICT_HINDI_ENDPOINT}`, { query: this.userInput })
        .subscribe((res: any) => {
          ...
          if (answers.length > 1) {
           ...
           this.http.post(`${API_URL}${TRANSLATE_HINDI_ENDPOINT}`, { query: formattedAnswers })
           .subscribe((res: any) => {
